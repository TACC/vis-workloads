#!/bin/bash 
#SBATCH -J dwrf_rgluray_t9_n8 
#SBATCH -N 8
#SBATCH -n 8 
#SBATCH -p vis 
#SBATCH -A A-ccvis 
#SBATCH -o /work/01891/adb/maverick/svb_adb/benchmarks/outs/dwrf_rgluray_t9_n8.out
#SBATCH -t 04:00:00
set -x
date
module load qt
...
export DISPLAY=:1
module load netcdf
DISPLAY=:0.0 ibrun -n 8 -o 0    /opt/apps/intel14/mvapich2_2_0/paraview/4.1.0/bin/pvbatch /work/01891/adb/maverick/svb_adb/pv_bench.py   -w 1920x1080  --nocamera --save_images -i /work/01891/adb/maverick/svb_adb/benchmarks/images/ --geoLevel 9 --numruns 10 --source wrf --immediatemode 
date
