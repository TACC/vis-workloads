#graph dynamicStrong_dfiu_animated_t6
set terminal svg
set output '/work/01891/adb/maverick/svb_adb/benchmarks/graphs/dynamicStrong_dfiu_animated_t6.svg'
set size 0.98,1.0
